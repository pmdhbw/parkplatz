        ...
        options = {
          ...
          onSelect: (function(_this) {
            return function(feature) {
              ...
              return _this._markerClick(feature, jQuery("#" + _this.map_div + "_marker_info"), this.handlers.feature.evt.clientX, this.handlers.feature.evt.clientY);
            };
          })(this)
        };
